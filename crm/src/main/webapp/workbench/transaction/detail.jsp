...
<%@ page import="com.dwadek.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.dwadek.crm.workbench.domain.Tran" %>
...
<script type="text/javascript">
	...
	function changeIcon(stage,index1) {
		...
		//如果当前阶段的可能性为0，前7个一定是黑圈后两个一个是红叉，一个是黑叉
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//如果当前阶段的可能性不为0，前面7个可能性是绿圈，绿色标记，黑圈，后两个一定是黑叉
			}else {
				...
				<%
					...
					//	如果遍历出来的可能性不为0，说明是前7个阶段 绿圈，绿色标记，黑圈
					}else {
