...
<head>
    ...
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            ...
                            //清空添加操作模态窗口中的数据
                            //虽然jquery对象没有为我们提供reset方法，但是原生js为我们提供了
        ...
        /*
            ...
            我们都在那些情况下 需要调用pageList方法（说明情况下需要刷新一下市场活动列表）
                1.点击左侧菜单中的“市场活动“链接
                2.添加，修改，删除后需要刷新
                3.点击查询按钮的时候
                4.点击分页组件的时候
