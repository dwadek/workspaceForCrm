        ...
        $(function () {
            ...
            $("#convertBtn").click(function () {
                ...
                if ($("#isCreateTransaction").prop("checked")) {
                    //alert("需要创建交易")
                    //如果需要创建交易，除了要为后台传递clueId之外，还得为后台传递交易的信息，金钱，预计成交日期，交易名称，交易阶段，市场活动源id
                    ...
                    //想到提交交易表单的形式发出本次的传统请求
                    //提交表单的参数不用我们手动取挂载（表单中学name属性），提交表单能够提交post请求
