...
import com.dwadek.crm.workbench.dao.*;
import com.dwadek.crm.workbench.domain.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //经过第二步以后，客户的信息我们已经拥有了，将来在处理其他表的时候，如果要使用到客户的id
        //直接使用cus.getId()
        //--------------------------------
        ...
        //经过第三步以后，联系人的信息我们已经拥有了，将来在处理其他表的时候，如果要使用到联系人的id
        //直接使用con.getId()
        //--------------------------------
        ...
        for(ClueRemark clueRemark:clueRemarkList){
            //取出备注信息（主要转换到客户备注和联系人备注的及时这个备注信息）
        ...
        for(ClueActivityRelation clueActivityRelation:clueActivityRelationList){
            ...
            //创建联系人和市场活动的关联关系对象，让第三步生成的联系人与市场活动做关联
